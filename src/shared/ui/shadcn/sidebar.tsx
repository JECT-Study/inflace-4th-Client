    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          <div className='min-h-screens flex w-full flex-col'>{children}</div>
        </SheetContent>
      </Sheet>
    )
  }
...
const sidebarMenuButtonVariants = cva(
  'peer/menu-button group/menu-button flex w-full overflow-hidden rounded-md p-2 text-left text-sm',
  {
    variants: {
      variant: {
        default:
