    ...
    <article className='mx-auto w-full max-w-5xl px-32 py-64 text-[17px] text-gray-800'>
      ...
      <Section title='제2조 (정의)'>
        ...
        <ol className='list-decimal space-y-8 pl-24 leading-32 text-gray-700'>
          ...
          <li>
            <strong>&ldquo;콘텐츠&rdquo;</strong>란 서비스 내에서 제공되는 매거진,
            분석 데이터, 보고서 등 일체의 정보를 의미합니다.
          </li>
        </ol>
      </Section>
      ...
      <Section title='제4조 (서비스의 제공 및 변경)'>
        <ol className='list-decimal space-y-12 pl-24 leading-32 text-gray-700'>
          ...
          <li>각 서비스 기능의 제공 범위는 구독 플랜에 따라 달라질 수 있습니다.</li>
          <li>
            회사는 서비스의 품질 향상, 기술적 필요 등 상당한 이유가 있는 경우
            제공하는 서비스를 변경할 수 있으며, 이 경우 변경 내용 및 일시를 사전에
            공지합니다.
          </li>
        </ol>
      </Section>
      ...
      <Section title='제5조 (서비스 이용계약의 성립)'>
        <ol className='list-decimal space-y-12 pl-24 leading-32 text-gray-700'>
          <li>
            이용계약은 이용자가 이 약관 및 개인정보처리방침에 동의하고 회원가입을
            완료함으로써 성립합니다.
          </li>
          <li>
            ...
            <ul className='mt-8 list-disc space-y-4 pl-24'>
              ...
              <li>
                기타 관련 법령 위반 또는 부당한 목적으로 서비스를 이용하려는 경우
              </li>
            </ul>
          </li>
        </ol>
      ...
      <Section title='제6조 (회원 계정 및 정보 관리)'>
        <ol className='list-decimal space-y-8 pl-24 leading-32 text-gray-700'>
          ...
          <li>
            계정 정보 유출 등 보안 문제 발생 시 즉시 회사에 통보하여야 하며, 통보
            전 발생한 손해에 대해 회사는 책임지지 않습니다.
          </li>
          <li>
            회원은 이메일 주소 변경 등 회원정보 변경 시 즉시 서비스 내에서 정보를
            수정하여야 합니다.
          </li>
        </ol>
      </Section>
      ...
      <Section title='제7조 (회원 탈퇴 및 자격 상실)'>
        <ol className='list-decimal space-y-12 pl-24 leading-32 text-gray-700'>
          ...
          <li>
            회원이 다음 각 호의 사유에 해당하는 경우 회사는 사전 통보 후 이용계약을
            해지할 수 있습니다.
            <ul className='mt-8 list-disc space-y-4 pl-24'>
        ...
        <ol className='list-decimal space-y-12 pl-24 leading-32 text-gray-700'>
          <li>
            ...
            <ul className='mt-8 list-disc space-y-4 pl-24'>
              ...
              <li>요금은 서비스 정책에 따라 변경될 수 있으며, 변경 시 30일 전 사전 공지합니다.</li>
            </ul>
          </li>
          <li>
          ...
          <li>
            결제는 토스페이먼츠를 통해 처리되며, 카드 정보는 회사가 직접 보관하지
            않습니다.
          </li>
        </ol>
      </Section>
      ...
      <Section title='제9조 (무료 체험)'>
        <ol className='list-decimal space-y-8 pl-24 leading-32 text-gray-700'>
          ...
          <li>
            무료 체험 종료 7일 전 이메일을 통해 자동 결제 예정 사실을 안내합니다.
          </li>
          <li>
      ...
      <Section title='제10조 (구독 플랜 변경)'>
        <ol className='list-decimal space-y-8 pl-24 leading-32 text-gray-700'>
          ...
          <li>
            <strong>다운그레이드</strong> (상위 플랜 → 하위 플랜): 현재 결제 주기
            만료 후 다음 결제 주기부터 변경된 플랜이 적용됩니다.
          </li>
      ...
      <Section title='제11조 (환불 정책)'>
        <ol className='list-decimal space-y-12 pl-24 leading-32 text-gray-700'>
          ...
          <li>무료 체험 기간 중에는 결제가 발생하지 않으므로 환불 대상이 아닙니다.</li>
        </ol>
      </Section>
        ...
        <ol className='list-decimal space-y-12 pl-24 leading-32 text-gray-700'>
          <li>
            ...
            <ul className='mt-8 list-disc space-y-4 pl-24'>
              ...
              <li>천재지변, 전쟁, 사이버 테러 등 불가항력적 사유가 발생한 경우</li>
              <li>서비스 운영상 긴급한 사유가 있는 경우</li>
            </ul>
          </li>
          <li>
            서비스 중단 시 회사는 사전에 공지합니다. 단, 불가피한 경우 사후 공지할
            수 있습니다.
          </li>
          <li>
      ...
      <Section title='제13조 (저작권 및 지식재산권)'>
        <ol className='list-decimal space-y-8 pl-24 leading-32 text-gray-700'>
          ...
          <li>
            이용자는 서비스에서 제공하는 콘텐츠를 회사의 사전 서면 동의 없이 복제,
            전송, 출판, 배포, 방송하거나 기타 방법으로 영리 목적으로 이용할 수
            없습니다.
          </li>
          <li>
      ...
      <Section title='제14조 (면책조항)'>
        <ol className='list-decimal space-y-8 pl-24 leading-32 text-gray-700'>
          <li>
            ...
            서비스를 제공할 수 없는 경우 서비스 제공에 관한 책임을 지지 않습니다.
          </li>
          <li>
          ...
          <li>
            회사는 서비스에서 제공하는 데이터 및 분석 정보의 정확성, 완전성에 대해
            보증하지 않으며, 이를 근거로 한 이용자의 의사결정에 대해 책임을 지지
            않습니다.
          </li>
          <li>
