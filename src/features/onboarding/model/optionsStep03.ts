import ImgInfluencerSearch from '../assets/onboarding-influencer-search.png'
import ImgChannelAnalysis from '../assets/onboarding-channel-analysis.png'
import ImgBrandFit from '../assets/onboarding-brand-fit.png'
