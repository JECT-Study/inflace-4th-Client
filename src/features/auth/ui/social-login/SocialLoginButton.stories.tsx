...
const meta = {
  ...
  argTypes: {
    ...
    icon: { control: false, description: '아이콘 (ReactNode)' },
  },
...
export const Overview: Story = {
  render: () => (
    <div className='flex flex-col gap-16 p-6'>
      <div>
        <p className='mb-8 text-sm text-gray-400'>Google — 활성</p>
        <SocialLoginButton icon={<GoogleIcon />} label='Continue with Google' />
      </div>
      <div>
