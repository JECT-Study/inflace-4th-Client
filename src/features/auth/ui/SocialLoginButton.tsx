...
export function SocialLoginButton({
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={cn(
        'flex h-[5.4rem] w-[35.2rem] items-center justify-center rounded-6 border border-stroke-border-gray-stronger bg-white transition-colors disabled:pointer-events-none disabled:opacity-50',
        className
      )}>
